...
//if(strpos(strtolower($value), strtolower($_GET['q']))){
if (strpos(strtolower($value), strtolower($_GET['q'])) !== false) {
$FileListNow.=$value.",";
}
}
...
/*
$input = preg_quote(strtolower(@$_GET['q']), '~'); // don't forget to quote input string!
