  ...
  <div class="container"> <br />
    <div class="row">
    	...
    	<div class="col-md-6">
            ...
            <a href="uploader_page.php" title="Uploader" target="_blank" class="btn btn-primary pull-right btn-rounded btn-sm" style="margin:2px;"><i class="glyphicon glyphicon-upload glyphicon-white"></i> Upload Files (Sample Single Page) </a><br>
...
<div class="center-orientation">
          <form action="" method="get" class=" navbar-form">
            ...
            <a href="index.php?q="><button type="button" class="form-control"><i class="glyphicon glyphicon-refresh"></i></button></a>

            <a href="file_manager_admin-login.php?q=" target="_blank" class="pull-right"><button type="button" class="form-control"><i class="glyphicon glyphicon-file"></i> File Manager</button></a>
...
<?php }?>) center no-repeat;">
			...
			<a href="download.php?id=<?php echo base64_encode($fileName); ?>"><strong><?php echo substr($value,-20,20); ?></strong></a><br>
...
<?php }?>            
    ...
    <a href="filemanager_page.php" title="Uploader" target="_blank" class="btn btn-primary pull-right btn-rounded btn-sm" style="margin:2px;"><i class="glyphicon glyphicon-list glyphicon-white"></i> Explor Files (Sample Single Page) </a>
       		</div>
    		</div>
		</div>        
